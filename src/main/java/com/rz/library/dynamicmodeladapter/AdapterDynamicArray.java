package com.rz.library.dynamicmodeladapter;
...
public class AdapterDynamicArray <T> extends ArrayAdapter<T> {
    ...
    public AdapterDynamicArray(Context argContext, int argLayoutResourceId, ArrayList<T> argListItems) {
