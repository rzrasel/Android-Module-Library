package com.rz.librarydotloader;

/**
 * Created by Rz Rasel on 2017-07-07.
 */
...
public class DotLoader extends View {
    ...
    https://android-arsenal.com/tag/76?page=2&sort=created
    */
    ...
    private void init(Context c, AttributeSet attrs) {
        ...
        try {
            ...
            //colors = c.getResources().getStringArray(R.array.dot_colors);
    ...
    public void shuffleArray(Integer[] argArray) {
